...
aquatic.animal_assign_enclosure(dip)
...
savannah.daily_tasks([jim.feed_animal(leo), bob.health_check(dip), jim.clean_enclosure(savannah)])
print(savannah)
print(aquatic)
jim.feed_animal(leo)
bob.health_check(leo)
print(leo)
leo.animal_total_health(leo,"Light", "There is a slight bruise on the right arm.", "There are no behavioural concerns", "9th of November")
jim.add_health_record(leo, "Yes", "No treatment required")
# print(savannah)
